...
- `apps/api`: API FastAPI y worker Python base.
...
PostgreSQL, Redis y MinIO quedan disponibles para futuras funcionalidades, pero este setup no crea modelos, tablas ni buckets.
